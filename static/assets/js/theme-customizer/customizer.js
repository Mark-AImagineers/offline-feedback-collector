(function ($) {
  ...
  $(
    '<div class="customizer-links"><div class="flex-column nac-pills nav" id="c-pills-tab" role="tablist" aria-orientation="vertical"><a class="nav-link" data-original-title="" href="#c-pills-home" aria-controls="c-pills-home" aria-selected="false" data-bs-toggle="pill" id="c-pills-home-tab" role="tab"><div class="settings"><img src="/yuri/yuriapp/static/assets/images/customizer/brush.png" alt=""></div><span>Quick option</span></a><a class="nav-link" data-original-title="" href="https://support.pixelstrap.com/" target="_blank"><div><img src="/yuri/yuriapp/static/assets/images/customizer/medical-kit.png" alt=""></div><span>Support</span></a><a class="nav-link" data-original-title="" href="https://docs.pixelstrap.net/admin/yuri/document/" target="_blank" target="_blank"><div><img src="/yuri/yuriapp/static/assets/images/customizer/setting-2.png" alt=""></div><span>Document</span></a><a class="nav-link" data-original-title="" href="https://admin.pixelstrap.net/yuri/template/landing-page.html" target="_blank"><div><img src="/yuri/yuriapp/static/assets/images/customizer/setting-5.png" alt=""></div><span>Check features</span></a><a class="nav-link" data-original-title="" href="https://themeforest.net/user/pixelstrap/portfolio" target="_blank"><div><img src="/yuri/yuriapp/static/assets/images/customizer/like-tag.png" alt=""></div><span>Buy now</span></a></div></div><div class="customizer-contain"><div class="tab-content" id="c-pills-tabContent"><div class="customizer-header"><i class="icofont-close icon-close"></i><h5>Preview Settings</h5><p class="mb-0">Try It Real Time<i class="fa fa-thumbs-o-up txt-primary"></i></div><div class="custom-scrollbar customizer-body"><div class="fade tab-pane" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab"><h6>Layout Type</h6><ul class="layout-grid main-layout"><li class="active" data-attr="ltr"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="bg-light sidebar"><li class="bg-light body"><span class="badge badge-primary">LTR</span></ul></div><li data-attr="rtl"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="bg-light body"><span class="badge badge-primary">RTL</span><li class="bg-light sidebar"></ul></div><li class="box-layout px-3" data-attr="ltr"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="bg-light sidebar"><li class="bg-light body"><span class="badge badge-primary">Box</span></ul></div></ul><h6>Sidebar Type</h6><ul class="layout-grid sidebar-type"><li data-attr="normal-sidebar"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="sidebar bg-dark"><li class="bg-light body"></ul></div><li data-attr="compact-sidebar"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="sidebar bg-dark compact"><li class="bg-light body"></ul></div></ul><h6>Sidebar Icon</h6><ul class="layout-grid sidebar-setting"><li class="active" data-attr="stroke-svg"><div class="bg-light header"><ul><li><li><li></ul></div><div class="bg-light body"><span class="badge badge-primary">Stroke</span></div></ul><h6>Unlimited Color</h6><ul class="layout-grid unlimited-color-layout"><input id="ColorPicker1" name="Background" type="color" value="#009DB5"> <input id="ColorPicker2" name="Background" type="color" value="#F94C8E"><button class="color-apply-btn color-apply-btn btn btn-primary" type="button">Apply</button></ul><h6>Light layout</h6><ul class="layout-grid customizer-color"><li class="color-layout" data-attr="color-1" data-primary="#009DB5" data-secondary="#F94C8E"><div></div><li class="color-layout" data-attr="color-2" data-primary="#898121" data-secondary="#4C4B16"><div></div><li class="color-layout" data-attr="color-3" data-primary="#31C6D4" data-secondary="#EF6262"><div></div><li class="color-layout" data-attr="color-4" data-primary="#FF7676" data-secondary="#FF4B91"><div></div><li class="color-layout" data-attr="color-5" data-primary="#8fa552" data-secondary="#8e49dd"><div></div><li class="color-layout" data-attr="color-6" data-primary="#BA704F" data-secondary="#C8AE7D"><div></div></ul><h6>Dark Layout</h6><ul class="layout-grid customizer-color dark"><li class="color-layout" data-attr="color-1" data-primary="#009DB5" data-secondary="#F94C8E"><div></div><li class="color-layout" data-attr="color-2" data-primary="#898121" data-secondary="#4C4B16"><div></div><li class="color-layout" data-attr="color-3" data-primary="#31C6D4" data-secondary="#EF6262"><div></div><li class="color-layout" data-attr="color-4" data-primary="#FF7676" data-secondary="#FF4B91"><div></div><li class="color-layout" data-attr="color-5" data-primary="#8fa552" data-secondary="#8e49dd"><div></div><li class="color-layout" data-attr="color-6" data-primary="#BA704F" data-secondary="#C8AE7D"><div></div></ul><h6>Mix Layout</h6><ul class="layout-grid customizer-mix"><li class="color-layout active" data-attr="light-only"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="bg-light sidebar"><li class="bg-light body"></ul></div><li class="color-layout" data-attr="dark-sidebar"><div class="bg-light header"><ul><li><li><li></ul></div><div class="body"><ul><li class="sidebar bg-dark"><li class="bg-light body"></ul></div><li class="color-layout" data-attr="dark-only"><div class="header bg-dark"><ul><li><li><li></ul></div><div class="body"><ul><li class="sidebar bg-dark"><li class="body bg-dark"></ul></div></ul></div></div></div></div>'
  ).appendTo($("body"));
  (function () {})();
  //live customizer js
    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/yuri/yuriapp/static/assets/images/logo/logo.png");
