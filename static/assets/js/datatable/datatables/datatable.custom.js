  ...
  $(document).ready(function () {
    ...
    $("#advance-8").DataTable({
      language: {
        url: "/yuri/yuriapp/static/assets/json/German.json",
      },
    });
    $("#advance-9").DataTable({
      searching: false,
    ...
    $("#data-source-2").DataTable({
      ajax: "/yuri/yuriapp/static/assets/ajax/arrays.txt",
    });
    var dataSet = [
      [
        "Tiger Nixon",
      ...
      ["Airi Satou", "Accountant", "Tokyo", "5407", "2024/11/28", "$162,700"],
      [
        "Brielle Williamson",
      ...
      ["Suki Burks", "Developer", "London", "6832", "2022/10/22", "$114,500"],
      [
        "Prescott Bartlett",
        "Technical Author",
        "London",
    ...
    $("#data-source-4").DataTable({
      ...
      ajax: "/yuri/yuriapp/static/assets/json/server-side.json",
    });
    ...
    var ct = $("#API-chield-row").DataTable({
      ajax: "/yuri/yuriapp/static/assets/ajax/api.txt",
      columns: [
        {
    ...
    $("#ajax-data-object").DataTable({
      ajax: "/yuri/yuriapp/static/assets/ajax/object.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: "/yuri/yuriapp/static/assets/ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: "/yuri/yuriapp/static/assets/ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "/yuri/yuriapp/static/assets/ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "/yuri/yuriapp/static/assets/ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
    ...
    $("#datatable-post").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "/yuri/yuriapp/static/assets/ajax/post.php",
        type: "post",
      },
      columns: [
        {
